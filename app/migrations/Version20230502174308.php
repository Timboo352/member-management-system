 ...
 */
final class Version20230502174308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, member_id INT NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
